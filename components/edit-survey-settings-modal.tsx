          ...
          <Card className="border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50">
            <CardHeader>
              ...
              <CardDescription className="text-slate-700">
                {surveyId ? "Comparte la encuesta usando el enlace público, código QR o WhatsApp" : "Guarda la encuesta primero para obtener opciones de compartir"}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {surveyId ? (
                <>
                  {/* Enlace público */}
                  <div className="space-y-3">
                    <h4 className="text-sm font-semibold text-slate-700">Enlace público de la encuesta</h4>
                  ...
                  {/* WhatsApp */}
                  {editedSettings.distributionMethods?.includes("whatsapp") && (
                    <div className="space-y-3">
                      <h4 className="text-sm font-semibold text-slate-700">Compartir por WhatsApp</h4>
                      <Button
                        variant="outline"
                  ...
                  {previewUrl && (
                    <div className="space-y-2 pt-2 border-t">
                      <h4 className="text-sm font-semibold text-slate-500">Enlace de Preview (interno)</h4>
                      <div className="flex items-center gap-2">
                        <a href={previewUrl} target="_blank" rel="noreferrer" className="text-sm text-primary underline truncate flex-1">{previewUrl}</a>
                ...
                <div className="text-sm text-muted-foreground">
                  Guarda la encuesta primero para generar el enlace público, código QR y opciones de compartir.
                </div>
              )}
            </CardContent>
          </Card>
