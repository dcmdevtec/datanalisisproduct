...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-[#18b0a4] focus-visible:ring-[#18b0a4] hover:data-[state=checked]:bg-[#139488] active:data-[state=checked]:bg-[#0e6e63]",
      "dark:data-[state=checked]:bg-[#18b0a4] dark:focus-visible:ring-[#18b0a4] dark:hover:data-[state=checked]:bg-[#139488]",
      className
    )}
    {...props}
    ref={ref}
